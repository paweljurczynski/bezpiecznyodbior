...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Odbiory techniczne mieszkań i domów od dewelopera i z rynku wtórnego. Termowizja, doradztwo, audyty energetyczne. Małopolskie, Śląskie, Podkarpackie. Bezpłatna wycena w 24h." },
      { property: "og:title", content: "Bezpieczny Odbiór — Odbiory techniczne mieszkań i domów" },
      { property: "og:description", content: "Rzetelne odbiory zgodne z Polskimi Normami. Termowizja i doradztwo inwestycyjne. Bezpłatna wycena w 24h." },
...
const whyUs = [
  ...
  { icon: FileCheck2, title: "Szczegółowy raport", desc: "Otrzymujesz kompletny protokół z wykrytymi wadami, zdjęciami i podstawą prawną roszczeń." },
  { icon: HardHat, title: "Doświadczeni inżynierowie", desc: "Zespół z uprawnieniami budowlanymi i setkami zrealizowanych odbiorów." },
];
...
const testimonials = [
  { name: "Anna K.", city: "Kraków", text: "Wykryli 47 usterek, których nie zauważyłabym. Deweloper wszystko poprawił.", rating: 5 },
  { name: "Marcin W.", city: "Katowice", text: "Profesjonalizm na najwyższym poziomie. Termowizja pokazała mostki, o których nikt nie mówił.", rating: 5 },
  { name: "Katarzyna B.", city: "Rzeszów", text: "Świetny raport i konkretne wskazówki. Polecam każdemu przed odbiorem.", rating: 5 },
];
  ...
  return (
    <>
        ...
        <div className="container-page grid gap-12 py-16 md:grid-cols-2 md:py-24">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              Kompleksowe kontrole inżynierskie nieruchomości zgodne z Polskimi
              Normami, umową deweloperską i projektami architektonicznymi.
              Wykorzystujemy specjalistyczne narzędzia, w tym badania
              termowizyjne.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild size="lg" variant="outline">
                <Link to="/oferta">Zobacz ofertę <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
            <div className="mt-10 grid grid-cols-3 gap-6 border-t border-border pt-6">
              ...
              <div><div className="text-2xl font-bold text-brand">4.9/5</div><div className="text-xs text-muted-foreground">Ocena klientów</div></div>
      ...
      <section className="container-page py-20">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {whyUs.map((f) => {
            const Icon = f.icon;
            return (
              <div key={f.title} className="surface-panel bg-card p-6 transition-shadow hover:shadow-elegant">
      ...
      <section className="container-page py-20">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {testimonials.map((t) => (
            <div key={t.name} className="surface-panel bg-card p-6">
      ...
      <section className="container-page pb-20">
        <div className="grid items-center gap-6 rounded-3xl bg-brand p-8 text-brand-foreground md:grid-cols-[auto_1fr_auto] md:p-10">
          <div className="grid h-14 w-14 place-items-center rounded-full bg-cta text-cta-foreground shrink-0">
          ...
          <div>
            ...
            <p className="mt-1 text-sm opacity-80">
              Kompleksowe bezpieczeństwo Twojej inwestycji w jednej usłudze.
            </p>
          </div>
          <Button asChild size="lg" className="btn-cta">
            <Link to="/oferta">Zobacz szczegóły</Link>
          </Button>
        </div>
      </section>
    </>
