...
export const services: Service[] = [
  {
    ...
    bullets: [
      "Potwierdzenie zgodności wymiarów zgodnie z rzutem architektonicznym",
      "Kontrola rozmieszczenia instalacji (elektryka, hydraulika, wentylacja)",
    ...
    checklist: [
      ...
      { title: "Wymiary lokalu", description: "Zgodność z rzutem architektonicznym" },
      ...
      { title: "Części wspólne graniczące z mieszkaniem", description: "Jakość wykonania klatki schodowej i korytarzy" },
    ],
    tools: [
      "Kamera termowizyjna",
      "Laser krzyżowy — wykrywanie odchyłek ścian i wylewek",
      "Wilgotnościomierz",
      "Dalmierz laserowy do potwierdzenia wymiarów",
  ...
  },
  {
    ...
    bullets: [
      "Ocena stanu instalacji i wykończenia",
  ...
  },
  {
    ...
    short: "Badanie termowizyjne — wykrywanie strat ciepła i wilgoci.",
    description:
    ...
    bullets: [
      "Profesjonalne badanie termowizyjne z dokumentacją fotograficzną",
    ...
    imageAlt: "Badanie termowizyjne nieruchomości",
